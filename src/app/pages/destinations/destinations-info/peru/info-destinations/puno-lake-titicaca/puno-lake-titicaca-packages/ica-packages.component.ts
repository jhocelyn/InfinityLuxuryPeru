...
@Component({
  selector: 'app-puno-lake-titicaca-packages',
    imports: [
        BannerComponent,
        PackageListToDestinationsComponent,
        SectionDestinationsComponent
...
export class IcaPackagesComponent {
  ...
  info: any = {};
  paquetes: any[] = [];
  ruta = "/destinations/peru/puno-lake-titicaca/"; // La ruta se mantiene igual para todos los paquetes
  ...
  loadTranslations() {
    this.translate.get('LIST_PACKAGES.PUNO').subscribe((data: any) => {
