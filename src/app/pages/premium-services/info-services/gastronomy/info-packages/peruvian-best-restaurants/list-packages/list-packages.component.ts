...
export class ListPackagesComponent {
  ...
  info = {
    ...
    titlePage: 'Peruvian Best Restaurants',
    button: 'View all packages',
    titleInfo: 'Peruvian Best Restaurants to',
  ...
  paquetes=[
    {nombre:'Paquete 1',imagen:'assets/img/incredibly-beatiful-site-of-machu-picchu-2023-11-27-05-12-24-utc_11zon.webp', descripcion:'Best Ways to Travel', id:1 , ruta:'/premium-services/gastronomy/peruvian-best-restaurants'},
    {nombre:'Paquete 2',imagen:'assets/img/incredibly-beatiful-site-of-machu-picchu-2023-11-27-05-12-24-utc_11zon.webp', descripcion:'Best Ways to Travel', id:2 , ruta:'/premium-services/gastronomy/peruvian-best-restaurants'},
  ]
