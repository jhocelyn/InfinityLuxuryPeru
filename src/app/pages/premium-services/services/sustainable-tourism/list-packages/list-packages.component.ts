...
export class ListPackagesComponent {
  ...
  info: any = {};
  paquetes: any[] = [];
  ruta = "/premium-services/sustainable-tourism"; // La ruta se mantiene igual para todos los paquetes
  ...
  loadTranslations() {
    this.translate.get('LIST_PACKAGES.SUSTAINABLE').subscribe((data: any) => {
