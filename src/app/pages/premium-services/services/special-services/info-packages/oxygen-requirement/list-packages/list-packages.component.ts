...
export class ListPackagesComponent {
  ...
  info = {
    ...
    titlePage: 'Oxygen Requirement',
    button: 'View all packages',
    titleInfo: 'Oxygen Requirement to',
  ...
  paquetes=[
    {nombre:'Paquete 1',imagen:'assets/img/incredibly-beatiful-site-of-machu-picchu-2023-11-27-05-12-24-utc_11zon.webp', descripcion:'Best Ways to Travel', id:1 , ruta:'/premium-services/special-services/oxygen-requirement'},
    {nombre:'Paquete 2',imagen:'assets/img/incredibly-beatiful-site-of-machu-picchu-2023-11-27-05-12-24-utc_11zon.webp', descripcion:'Best Ways to Travel', id:2 , ruta:'/premium-services/special-services/oxygen-requirement'},
  ]
