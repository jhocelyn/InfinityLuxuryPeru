...
export class ListPackagesComponent {
  ...
  info: any = {};
  paquetes: any[] = [];
  ruta = "/premium-services/gastronomy/peruvian-cooking-class"; // La ruta se mantiene igual para todos los paquetes
  ...
  loadTranslations() {
    this.translate.get('LIST_PACKAGES.CLASS').subscribe((data: any) => {
