...
export class ListPackagesComponent {
  ...
  info: any = {};
  paquetes: any[] = [];
  ruta = "/premium-services/gastronomy/peruvian-best-restaurants"; // La ruta se mantiene igual para todos los paquetes
  ...
  loadTranslations() {
    this.translate.get('LIST_PACKAGES.RESTAURANTS').subscribe((data: any) => {
