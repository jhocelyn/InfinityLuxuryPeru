...
export class ListPackagesComponent {
  ...
  info: any = {};
  paquetes: any[] = [];
  ruta = "/premium-services/family-best-experiences/"; // La ruta se mantiene igual para todos los paquetes
  ...
  loadTranslations() {
    this.translate.get('LIST_PACKAGES.FAMILY').subscribe((data: any) => {
